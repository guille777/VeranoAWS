  ...
  <?php
    if(isset($_POST["accion"])){
      ...
      // include "lib/seguridad.php";
        ...
        // var_dump($_POST);
          if (!empty($_POST["usuario"]) && !empty($_POST["nombre"]) && !empty($_POST["apellidos"]) && !empty($_POST["email"]) && !empty($_POST["pass"]) && !empty($_POST["pass2"])) {
          // echo "datos validados";
          // echo "<br>";
            if($_POST["pass"]==$_POST["pass2"]){
              // echo "contraseña valida";
              //se puede mejoar con un select de roles, que ataca o recoge la tabla roles en BD
              $resultado=$user->insertarUsuario($_POST["usuario"],$_POST["nombre"],$_POST["apellidos"],$_POST["email"],$_POST["pass"]);
                if($resultado!=null){
